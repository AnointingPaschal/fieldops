export const MOCK_TASKS = [
  {
    ...
    employees: [{ name: 'Marcus Reid', initials: 'MR', color: '#2563EB' }],
    items: [{ name: 'Arrow Board', qty: 2, unit: 'unit' }, { name: 'Traffic Cone', qty: 20, unit: 'cone' }],
  ...
  },
  {
    ...
    employees: [{ name: 'Kayla Thompson', initials: 'KT', color: '#16A34A' }],
    items: [{ name: 'Type III Barricade', qty: 8, unit: 'unit' }, { name: 'Barricade Light', qty: 12, unit: 'unit' }],
  ...
  },
  {
    ...
    employees: [{ name: 'Marcus Reid', initials: 'MR', color: '#2563EB' }, { name: 'Priya Nair', initials: 'PN', color: '#7C3AED' }],
    items: [{ name: 'Channelizer Drum', qty: 15, unit: 'unit' }, { name: 'Traffic Cone', qty: 30, unit: 'cone' }],
...
export const MOCK_WORKERS = [
  { id: 'w1', name: 'Marcus Reid',    title: 'Field Technician',    initials: 'MR', color: '#2563EB', available: true,  phone: '+1 (587) 234-5678' },
  { id: 'w2', name: 'Kayla Thompson', title: 'Equipment Specialist', initials: 'KT', color: '#16A34A', available: true,  phone: '+1 (587) 345-6789' },
  { id: 'w3', name: 'Devon Clarke',   title: 'Field Technician',    initials: 'DC', color: '#FF6B35', available: false, phone: '+1 (587) 456-7890' },
  { id: 'w4', name: 'Priya Nair',     title: 'Senior Technician',   initials: 'PN', color: '#7C3AED', available: true,  phone: '+1 (587) 567-8901' },
  { id: 'w5', name: 'Ryan Okafor',    title: 'Equipment Specialist', initials: 'RO', color: '#F59E0B', available: false, phone: '+1 (587) 678-9012' },
];
...
export const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string; dot: string }> = {
  pending:    { label: 'Pending',    color: '#64748B', bg: 'rgba(100,116,139,0.10)', dot: '#64748B' },
  assigned:   { label: 'Assigned',   color: '#2563EB', bg: 'rgba(37,99,235,0.10)',   dot: '#2563EB' },
  accepted:   { label: 'Accepted',   color: '#FF6B35', bg: 'rgba(255,107,53,0.10)',  dot: '#FF6B35' },
  in_transit: { label: 'In Transit', color: '#F59E0B', bg: 'rgba(245,158,11,0.10)',  dot: '#F59E0B' },
  completed:  { label: 'Completed',  color: '#16A34A', bg: 'rgba(22,163,74,0.10)',   dot: '#16A34A' },
  cancelled:  { label: 'Cancelled',  color: '#DC2626', bg: 'rgba(220,38,38,0.10)',   dot: '#DC2626' },
};

export const TASK_TYPE_CONFIG: Record<string, { label: string; color: string; icon: string }> = {
  delivery:  { label: 'Delivery',   color: '#2563EB', icon: '📦' },
  pickup:    { label: 'Pick Up',    color: '#F59E0B', icon: '🔄' },
  setup:     { label: 'Set Up',     color: '#16A34A', icon: '🔧' },
  teardown:  { label: 'Tear Down',  color: '#DC2626', icon: '🗑️' },
};
